...
@endsection
@section('title')
    Update Master Jenis Grading Warna
@endsection
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card border border-primary border-3 shadow-sm rounded">
                    <div class="card-header">
                        <h4>UPDATE DATA MASTER JENIS GRADING WARNA</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('MasterJenisGradingWarna.update', $MasterJenisGradingWarna->id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="jenis"
                                    value="{{ old('jenis', $MasterJenisGradingWarna->jenis) }}">
                                <!-- error message -->
                                @error('jenis')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kategori_susut"
                                    value="{{ old('kategori_susut', $MasterJenisGradingWarna->kategori_susut) }}">
                                <!-- error message -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="upah_operator"
                                    value="{{ old('upah_operator', $MasterJenisGradingWarna->upah_operator) }}">
                                <!-- error message -->
                                @error('upah_operator')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="pengurangan_harga"
                                    value="{{ old('pengurangan_harga', $MasterJenisGradingWarna->pengurangan_harga) }}">
                                <!-- error message -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="harga_estimasi"
                                    value="{{ old('harga_estimasi', $MasterJenisGradingWarna->harga_estimasi) }}">
                                <!-- error message -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="user_created" placeholder="Masukkan User Updated"
                                    class="form-control" value="{{ old('nama', $MasterJenisGradingWarna->user_created) }}">
                                <!-- error message -->
                                @error('user_created')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" @error('status') is-invalid @enderror" name="status">
                                    <option value="1" {{ $MasterJenisGradingWarna->status == 1 ? 'selected' : '' }}>
                                        Aktif
                                    </option>
                                    <option value="0" {{ $MasterJenisGradingWarna->status == 0 ? 'selected' : '' }}>
                                        Tidak
                                        Aktif
                                    </option>
                                </select>
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <a href="{{ Route('MasterJenisGradingWarna.index') }}" type="button"
