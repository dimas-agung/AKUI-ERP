...
@section('content')
    ...
    <div class="row">
        ...
        <div class="card border border-primary border-3">
            ...
            <div class="card-body">
                <form action="{{ route('master_tujuan_kirim_raw_material.update', $stockTGK->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nomor_bstb') is-invalid @enderror" name="nomor_bstb"
                            value="{{ old('nomor_bstb', $stockTGK->nomor_btsb) }}" placeholder="Masukkan nomor bstb">
