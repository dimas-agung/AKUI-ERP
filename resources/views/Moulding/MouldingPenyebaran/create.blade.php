        ...
        <div class="card mt-2 border border-primary border-3">
            <div class="card-header">
                <div class="d-flex align-items-center mb-3">
                    <h4 class="card-title">Moulding Penyebaran</h4>
                </div>
                <hr>
                <form method="POST" class="row g-3" id="myForm">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="select2 form-select" style="width: 100%;" tabindex="-1" aria-hidden="true"
                            ...
                            @foreach ($master_operator as $item)
                    ...
                    <div class="col-12">
                        ...
                        <a href="{{ Route('MouldingPenyebaran.index') }}" type="button" class="btn btn-danger">Close</a>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#nomor_job').on('change', function() {
                ...
                $.ajax({
                    url: '{{ route('MouldingPenyebaran.setJob') }}',
                    method: 'GET',
                    data: {
        ...
        $(document).ready(function() {
            ...
            $('#nip_operator').on('change', function() {
                ...
                $.ajax({
                    url: '{{ route('MouldingPenyebaran.setNip') }}',
                    method: 'GET',
                    data: {
                        nip: selectedNip
                    },
        ...
        function CeksendData() {
            ...
            $.ajax({
                url: `{{ route('MouldingPenyebaran.CeksendData') }}`, // Ganti dengan URL endpoint yang sesuai untuk memeriksa ketersediaan id box
                method: 'POST',
                data: {
            ...
            function sendData(waktu_penyebaran) {
                ...
                $.ajax({
                    url: '{{ route('MouldingPenyebaran.store') }}',
                    method: 'POST',
                    beforeSend: function() {
                        Swal.fire({
                            title: 'Loading...',
