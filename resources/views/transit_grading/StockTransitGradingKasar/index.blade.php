                    ...
                    <table id="table1" class="display" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{!! number_format($post->berat_keluar, 2, ',', '.') !!}</td>
                                <td class="text-center">{!! number_format($post->pcs_keluar, 0, ',', '.') !!}</td>
                                ...
                                <td class="text-center">{!! number_format($post->modal, 0, ',', '.') !!}</td>
                                <td class="text-center">{!! number_format($post->total_modal, 0, ',', '.') !!}</td>
                                <td class="text-center">{!! number_format($post->biaya_produksi, 0, ',', '.') !!}</td>
                                <td class="text-center">{!! number_format($post->fix_total_modal, 0, ',', '.') !!}</td>
