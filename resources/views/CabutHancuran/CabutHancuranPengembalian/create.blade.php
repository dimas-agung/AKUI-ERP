        ...
        <div class="card mt-2 border border-primary border-3">
            <div class="card-header">
                <div class="d-flex align-items-center mb-3">
                    <h4 class="card-title">Cabut Bulu Hancuran Pengembalian</h4>
                </div>
                <hr>
                <form method="POST" class="row g-3" id="myForm">
                    ...
                    <div class="col-12">
                        ...
                        <a href="{{ Route('CabutHancuranPengembalian.index') }}" type="button"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#nomor_job').on('change', function() {
                ...
                $.ajax({
                    url: '{{ route('CabutHancuranPengembalian.set') }}',
                    method: 'GET',
                    data: {
        ...
        function CeksendData() {
            ...
            $.ajax({
                url: `{{ route('CabutHancuranPengembalian.CeksendData') }}`, // Ganti dengan URL endpoint yang sesuai untuk memeriksa ketersediaan id box
                method: 'POST',
                data: {
            ...
            function sendData(waktu_pengembalian) {
                ...
                $.ajax({
                    url: '{{ route('CabutHancuranPengembalian.store') }}',
                    method: 'POST',
                    beforeSend: function() {
                        Swal.fire({
                            title: 'Loading...',
