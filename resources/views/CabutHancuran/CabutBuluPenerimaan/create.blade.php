...
@endsection
@section('title')
    Data Cabut Bulu Penerimaan
@endsection
@section('content')
    <div class="container">
        <div class="card border border-primary border-3 mt-2">
            <form action="{{ route('CabutBuluPenerimaan.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="card border-0 shadow-sm rounded">
                            <div class="card-header">
                                <h4>Input Data Cabut Bulu Penerimaan</h4>
                            </div>
                            <div class="card-body">
                                {{-- Create Data --}}
                                        ...
                                        <div class="card">
                                            <div class="card-body" style="overflow: scroll" content="{{ csrf_token() }}">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <a href="{{ Route('CabutBuluPenerimaan.index') }}" type="button"
    ...
    <script>
        ...
        $('#nomor_bstb').on('change', function() {
            ...
            if (selectedNomorBSTB !== selectedIdBox) {
                ...
                $.ajax({
                    url: `{{ route('CabutBuluPenerimaan.set') }}`,
                    method: 'GET',
                    data: {
                        nomor_bstb: selectedIdBox
                    },
                    success: function(response) {
                        if (response.length > 0 && response[0].berat_job > 0) {
        ...
        function CeksendData() {
            ...
            $.ajax({
                url: `{{ route('CabutBuluPenerimaan.CeksendData') }}`, // Ganti dengan URL endpoint yang sesuai untuk memeriksa ketersediaan id box
                method: 'POST',
                data: {
            ...
            function sendData() {
                ...
                $.ajax({
                    url: '{{ route('CabutBuluPenerimaan.store') }}',
                    method: 'POST',
                    beforeSend: function() {
                        Swal.fire({
                            title: 'Loading...',
