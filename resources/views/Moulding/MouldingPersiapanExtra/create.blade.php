...
@endsection
@section('title')
    Data Moulding Persiapan Extra
@endsection
@section('content')
    {{-- <div class="container"> --}}
    <div class="card border border-primary border-3 mt-2">
        <form action="{{ route('MouldingPersiapanExtra.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="card border-0 shadow-sm rounded">
                        <div class="card-header">
                            <h4>Input Data Moulding Persiapan Extra</h4>
                        </div>
                        <div class="card-body">
                            {{-- Create Data --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @foreach ($MouldingStocks as $innerPost)
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="{{ Route('MouldingPersiapanExtra.index') }}" type="button" class="btn btn-danger"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#id_box_grading_warna').on('change', function() {
                ...
                $.ajax({
                    url: `{{ route('MouldingPersiapanExtra.set') }}`,
                    method: 'GET',
                    data: {
        ...
        $('#job_order').on('change', function() {
            ...
            $.ajax({
                url: '{{ route('MouldingPersiapanExtra.setpcc') }}',
                method: 'GET',
                data: {
        ...
        function CeksendData() {
            ...
            $.ajax({
                url: `{{ route('MouldingPersiapanExtra.CeksendData') }}`, // Ganti dengan URL endpoint yang sesuai untuk memeriksa ketersediaan id box
                method: 'POST',
                data: {
            ...
            function sendData() {
                ...
                $.ajax({
                    url: '{{ route('MouldingPersiapanExtra.store') }}',
                    method: 'POST',
                    beforeSend: function() {
                        Swal.fire({
                            title: 'Loading...',
