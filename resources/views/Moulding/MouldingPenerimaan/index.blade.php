        ...
        <div class="card border border-primary border-3">
            <div class="card-header">
                <div class="col-sm-12 d-flex justify-content-between">
                    <h4 class="card-title">Data Moulding Persiapan</h4>
                    <a href="{{ Route('MouldingPersiapan.create') }}" class="btn btn-outline-success rounded-pill">
                        ...
                        <tbody>
                            ...
                            @empty
                                <div class="alert alert-danger">
                                    Data Moulding Persiapan belum Tersedia.
                                </div>
                            @endforelse
                        </tbody>
                    </table>
