                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-primary">
                                    <h4 class="modal-title white" id="myModalLabel33">Input Data Master Jenis Rambang
                                    </h4>
                                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                        <i data-feather="x"></i>
                                    </button>
                                </div>
                                <form action="{{ route('MasterJenisRambang.store') }}" method="POST">
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <div class="table-responsive">
                            <table id="table1" class="display" style="width:100%">
                                ...
                                <tbody>
                                    @forelse ($master_jenis_rambang as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="form-button-action">
                                                    <form style="display: flex" id="deleteForm{{ $item->id }}"
                                                        action="{{ route('MasterJenisRambang.destroy', $item->id) }}"
                                                        method="POST">
                                                        <a href="{{ route('MasterJenisRambang.edit', $item->id) }}"
                                    ...
                                    @empty
                                        <div class="alert alert-danger">
                                            Data Master Jenis Rambang belum Tersedia.
                                        </div>
                                    @endforelse
                                </tbody>
                            </table>
