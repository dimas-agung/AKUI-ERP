                        ...
                        <tbody>
                            @forelse ($PreGHI as $item)
                                <tr>
                                    ...
                                    <td class="text-center">{{ number_format($item->berat_adding, 2, ',', '.') }}</td>
                                    <td class="text-center">{{ number_format($item->pcs_adding, 0, ',', '.') }}</td>
                                    <td class="text-center">{{ $item->jenis_grading }}</td>
                                    <td class="text-center">{{ number_format($item->berat_grading, 2, ',', '.') }}</td>
                                    <td class="text-center">{{ number_format($item->pcs_grading, 0, ',', '.') }}</td>
                                    ...
                                    <td class="text-center">{{ number_format($item->biaya_produksi, 0, ',', '.') }}</td>
                                    <td class="text-center">{{ $item->kontribusi }}</td>
                                    <td class="text-center">{{ number_format($item->harga_estimasi, 0, ',', '.') }}</td>
                                    <td class="text-center">{{ number_format($item->total_harga, 0, ',', '.') }}</td>
                                    ...
                                    <td class="text-center">{{ number_format($item->hpp, 0, ',', '.') }}</td>
                                    <td class="text-center">{{ number_format($item->total_hpp, 0, ',', '.') }}</td>
                                    <td class="text-center">{{ number_format($item->fix_hpp, 0, ',', '.') }}</td>
                                    <td class="text-center">{{ number_format($item->fix_total_hpp, 0, ',', '.') }}</td>
