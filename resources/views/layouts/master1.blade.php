            ...
            <div class="sidebar-wrapper border-end border-primary border-3 active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li
                                        ...
                                        <a href="{{ route('MasterTujuanKirimRawMaterial.index') }}"
                                            class="submenu-link">Master Tujuan <br> Kirim Raw Material</a>
                                    </li>

                                    <li
                                        class="submenu-item {{ Route::is('MasterTujuanKirimGradingKasar*') ? 'active' : '' }}">
                                        <a href="{{ route('MasterTujuanKirimGradingKasar.index') }}"
                                            class="submenu-link">Master Tujuan <br> Kirim Grading <br> Kasar</a>
                                    </li>

                                    <li
                                        class="submenu-item {{ Route::is('MasterTujuanKirimGradingHalus*') ? 'active' : '' }}">
                                        <a href="{{ route('MasterTujuanKirimGradingHalus.index') }}"
                                            class="submenu-link">Master Tujuan <br> Kirim Grading <br> Halus</a>
                                    </li>
                        ...
                        {{-- PPIC --}}
                        @role('ppic')
                            <li class="sidebar-title">PPIC</li>
                            <li
                            ...
                            <li
                                ...
                                <ul class="submenu">
                                    <li
                                        class="submenu-item has-sub {{ Route::is('TransitDryAHancuran*', 'GradingWarnaPenerimaan*','GradingWarnaAdding*', 'GradingWarnaAddingStock*', 'GradingWarna*', 'GradingWarnaStock*') ? 'active' : '' }}">
                                        <a href="#" class='submenu-link'>
                                        ...
                                        <ul class="submenu submenu-level-2">
                                            ...
                                            <li class="submenu-item {{ Route::is('TransitDryAHancuran*') ? 'active' : '' }}">
                                                <a href="{{ route('TransitDryAHancuran.index') }}"
                                                    class="submenu-link">Transit Dry A Hancuran</a>
                                            </li>
                                    ...
                                    <li
                                        class="submenu-item has-sub {{ Route::is('MouldingWasteInput*', 'MouldingWasteStock*') ? 'active' : '' }}">
                                        <a href="#" class='submenu-link'>
...
>>>>>>> dev2
                                    ...
                                    @role('grading_halus|admin')
                                        <li
                                            ...
                                            <ul class="submenu submenu-level-2">
                                                @if (Auth::user()->nip == '223030557' || Auth::user()->nip == '12345678' || Auth::user()->nip == '221050218')
                                                    <li
                                                        class="submenu-item {{ Route::is('TransitPreCleaningStock*') ? 'active' : '' }}">
                                                        <a href="{{ route('TransitPreCleaningStock.index') }}"
                                                            class="submenu-link">Transit Pre Cleaning Stock</a>
                                    ...
                                    <li
                                        ...
                                        <ul class="submenu submenu-level-2">
                                            ...
                                            <li class="submenu-item {{ Route::is('PreWashInput*') ? 'active' : '' }}">
                                                <a href="{{ route('PreWashInput.index') }}" class="submenu-link">Pre
                                                    Wash
                                                    <br>Input</a>
                                            </li>
                                            <li class="submenu-item {{ Route::is('PreWashStock*') ? 'active' : '' }}">
...
=======
                                    @role('pre_wash|admin')
                                        <li
                                            class="submenu-item has-sub {{ Route::is('TransitGradingHalus*', 'PreWashInput*', 'PreWashOutput*', 'PreWashStock*', 'TransitPreWash*') ? 'active' : '' }}">
                                            <a href="#" class='submenu-link'>
                                                <span>Pre-Wash</span>
                                            </a>
                                            <ul class="submenu submenu-level-2">
                                    ...
                                    <li
                                        ...
                                        <ul class="submenu submenu-level-2">
                                            ...
                                            <li
                                                ...
                                                <a href="{{ route('RambangKeringInput.index') }}"
                                                    class="submenu-link">Rambang
                                                    Kering
                                                    <br>Input</a>
                                            </li>
                            ...
                            <li
                                ...
                                <ul class="submenu">
                                    ...
                                    <li
                                        ...
                                        <ul class="submenu submenu-level-2">
                                            <li
                                                class="submenu-item {{ Route::is('DryAWasteInput*') && !Route::is('DryAWasteStock*') ? 'active' : '' }}">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li
                                        ...
                                        <a href="#" class='submenu-link'>
                                            ...
                                            <li
                                                class="submenu-item {{ Route::is('MouldingPenyebaran*') ? 'active' : '' }}">
