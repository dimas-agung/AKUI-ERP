...
@endsection
@section('title')
    Master Tujuan Kirim Grading Kasar
@endsection
@section('content')
    <div class="col-md-12">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-primary">
                                    <h4 class="modal-title white" id="myModalLabel33">Input Data Master Tujuan Kirim Grading
                                        Kasar</h4>
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <div class="table-responsive">
                            <table id="table1" class="display" style="width:100%">
                                ...
                                <tbody>
                                    @forelse ($master_tujuan_kirim_grading_kasar as $MasterTJGK)
                                        <tr>
                                            <td class="text-center">{{ $i++ }}</td>
                                            <td class="text-center">{{ $MasterTJGK->tujuan_kirim }}</td>
                                            <td class="text-center">{{ $MasterTJGK->letak_tujuan }}</td>
                                            <td class="text-center">{{ $MasterTJGK->inisial_tujuan }}</td>
                                            <td class="text-center">
                                                @if ($MasterTJGK->status == 1)
                                                    Aktif
                                                @else
                                                    Tidak Aktif
                                                @endif
                                            </td>
                                            <td class="text-center">{{ $MasterTJGK->created_at }}</td>
                                            <td class="text-center">
                                                {{ $MasterTJGK->created_at != $MasterTJGK->updated_at ? $MasterTJGK->updated_at : '' }}
                                            </td>
                                            <td class="text-center">
                                                <div class="form-button-action">
                                                    <form style="display: flex" id="deleteForm{{ $MasterTJGK->id }}"
                                                        ...
                                                        <button type="button" class="btn btn-link"
                                                            ...
                                                            onclick="confirmDelete({{ $MasterTJGK->id }})">
                                    ...
                                    @empty
                                        <div class="alert alert-danger">
                                            Data Master Tujuan Kirim Grading Kasar belum Tersedia.
                                        </div>
                                    @endforelse
                                </tbody>
                            </table>
