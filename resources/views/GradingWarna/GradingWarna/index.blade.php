                    ...
                    <div class="card-body" style="overflow: auto;">
                        ...
                        <div class="table-responsive">
                            <table id="table1" class="display" style="width:100%">
                                ...
                                <tbody>
                                    @forelse ($grading_warna as $item)
                                        <tr>
                                            <td class="text-center">{{ $loop->iteration }}</td>
                                            <td class="text-center">{{ $item->nomor_lot }}</td>
                                            <td class="text-center">{{ $item->nomor_batch }}</td>
                                            <td class="text-center">{{ $item->berat_lot }}</td>
                                            <td class="text-center">{{ $item->pcs_lot }}</td>
                                    ...
                                    @empty
                                        <div class="alert alert-danger">
                                            Data Grading Warna belum Tersedia.
                                        </div>
                                    @endforelse
                                </tbody>
                            </table>
...
@section('script')
    <script>
        ...
        function applyFilter() {
            ...
            var url = '{{ route('GradingWarna.index') }}';
