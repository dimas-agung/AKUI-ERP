...
@endsection
@section('title')
    Update Master Tujuan Kirim Grading Halus
@endsection
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card border border-primary border-3 shadow-sm rounded">
                    <div class="card-header">
                        <h4>UPDATE DATA MASTER TUJUAN KIRIM GRADING HALUS</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('MasterTujuanKirimGradingHalus.update', $MasterTJRM->id) }}" method="POST">
                            @csrf
                            @method('PUT')
