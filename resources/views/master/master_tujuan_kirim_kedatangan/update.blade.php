...
@endsection
@section('title')
    Update Master Tujuan Kirim Kedatangan
@endsection
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card border border-primary border-3 shadow-sm rounded">
                    <div class="card-header">
                        <h4>UPDATE DATA MASTER TUJUAN KIRIM KEDATANGAN</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('MasterTujuanKirimKedatangan.update', $MasterTujuanKirimKedatangan->id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tujuan_kirim') is-invalid @enderror"
                                    name="tujuan_kirim"
                                    value="{{ old('tujuan_kirim', $MasterTujuanKirimKedatangan->tujuan_kirim) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('letak_tujuan') is-invalid @enderror"
                                    name="letak_tujuan"
                                    value="{{ old('letak_tujuan', $MasterTujuanKirimKedatangan->letak_tujuan) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('inisial_tujuan') is-invalid @enderror"
                                    name="inisial_tujuan"
                                    value="{{ old('inisial_tujuan', $MasterTujuanKirimKedatangan->inisial_tujuan) }}"
                                    placeholder="Masukkan Letak Tujuan">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" @error('status') is-invalid @enderror" name="status"
                                    value="{{ old('status', $MasterTujuanKirimKedatangan->status) }}">
                                    <option value="1"
                                        {{ $MasterTujuanKirimKedatangan->status == 1 ? 'selected' : '' }}>
                                        AKTIF</option>
                                    <option value="0"
                                        {{ $MasterTujuanKirimKedatangan->status == 0 ? 'selected' : '' }}>
                                        TIDAK AKTIF
                                    </option>
                                </select>
                                <!-- error message untuk title -->
                            ...
                            <a href="{{ Route('MasterTujuanKirimKedatangan.index') }}" type="button"
