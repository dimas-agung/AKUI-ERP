                    ...
                    <div class="card-body" style="overflow: auto;">
                        ...
                        <div class="table-responsive">
                            <table id="table1" class="display" style="width:100%">
                                ...
                                <tbody>
                                    @forelse ($moulding_penyebaran as $item)
                                        <tr>
                                                ...
                                                <div class="form-button-action">
                                                    @if ($item->can_delete())
                                                        <form style="display: flex" id="deleteForm{{ $item->nomor_job }}"
                                                            action="{{ route('MouldingPenyebaran.destroy', $item->nomor_job) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                    ...
                                    @empty
                                        <div class="alert alert-danger">
                                            Data Moulding Penyebaran belum Tersedia.
                                        </div>
                                    @endforelse
                                </tbody>
                            </table>
...
@section('script')
    <script>
        ...
        function applyFilter() {
            ...
            var url = '{{ route('MouldingPenyebaran.index') }}';
        ...
        function redirectToPage() {
            window.location.href = "{{ route('MouldingPenyebaran.create') }}";
        }
