                            ...
                            @forelse ($PreGHI as $item)
                                <tr>
                                    ...
                                    @role('admin')
                                        ...
                                        <td class="text-center">{{ number_format($item->nilai_laba_rugi, 2, ',', '.') }}</td>
                                        <td class="text-center">{{ number_format($item->nilai_prosentase_total_keuntungan, 2, ',', '.') }}</td>
                                        <td class="text-center">{{ number_format($item->prosentase_harga_gramasi, 2, ',', '.') }}</td>
                                        <td class="text-center">{{ number_format($item->selisih_laba_rugi_kg, 2, ',', '.') }}</td>
                                        <td class="text-center">{{ number_format($item->selisih_laba_rugi_per_gram, 2, ',', '.') }}</td>
