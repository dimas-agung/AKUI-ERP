                    ...
                    <div class="modal fade text-left modal-borderless" id="inlineForm" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('MasterJobMoulding.store') }}" method="POST">
                                            ...
                                            <td class="text-center">
                                                <div class="form-button-action">
                                                    <form style="display: flex" id="deleteForm{{ $item->id }}"
                                                        action="{{ route('MasterJobMoulding.destroy', $item->id) }}"
                                                        method="POST">
                                                        <a href="{{ route('MasterJobMoulding.edit', $item->id) }}"
