        ...
        <div class="card border border-primary border-3">
            <div class="card-header">
                <div class="col-sm-12 d-flex justify-content-between">
                    <h4 class="card-title">Data Dry A Penerimaan</h4>
                    <div style="position: absolute;right: 25px;">
                        <a class="btn btn-outline-warning rounded-pill" style="margin-right: 10px" onclick="toggleFilter()">
                            <strong>Filter</strong>
                        </a>
                        <a href="{{ route('DryAPenerimaan.create') }}" class="btn btn-outline-success rounded-pill">
                        ...
                        <tbody>
                                        ...
                                        <div class="form-button-action">
                                            @if ($item->status == 1)
                                                <form style="display: flex" id="deleteForm{{ $item->nomor_job }}"
                                                    action="{{ route('DryAPenerimaan.destroy', $item->nomor_job) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            @empty
                                <div class="alert alert-danger">
                                    Data Dry A Penerimaan belum Tersedia.
                                </div>
                            @endforelse
                        </tbody>
                    </table>
