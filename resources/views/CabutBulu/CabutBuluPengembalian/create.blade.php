...
@endsection
@section('title')
    Input Cabut Bulu Pengembalian
@endsection
@section('content')
    {{-- <div class="container"> --}}
    <div class="card border border-primary border-3 mt-2">
        <form action="{{ route('CabutBuluPengembalian.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="card border-0 shadow-sm rounded">
                        <div class="card-header">
                            <h4>Input Data Cabut Bulu Pengembalian</h4>
                        </div>
                        <div class="card-body">
                            {{-- Create Data --}}
