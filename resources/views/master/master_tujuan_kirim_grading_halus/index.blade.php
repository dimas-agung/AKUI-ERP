...
@endsection
@section('title')
    Master Tujuan Kirim Grading Halus
@endsection
@section('content')
    <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h5 class="card-title">
                            <div class="col-sm-12 d-flex justify-content-between">
                                Data Master Tujuan Kirim Grading Halus
                                <button href="{{ route('MasterTujuanKirimGradingHalus.create') }}" type="button"
                    ...
                    <div class="modal fade text-left modal-borderless" id="inlineForm" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('MasterTujuanKirimGradingHalus.store') }}" method="POST">
                                ...
                                <tbody>
                                            ...
                                            <td class="text-center">
                                                <div class="form-button-action">
                                                    <form style="display: flex" id="deleteForm{{ $MasterTJRM->id }}"
                                                        action="{{ route('MasterTujuanKirimGradingHalus.destroy', $MasterTJRM->id) }}"
                                                        method="POST">
                                                        <a href="{{ route('MasterTujuanKirimGradingHalus.edit', $MasterTJRM->id) }}"
                                    ...
                                    @empty
                                        <div class="alert alert-danger">
                                            Data Master Tujuan Kirim Grading Halus belum Tersedia.
                                        </div>
                                    @endforelse
                                </tbody>
                            </table>
