            ...
            <div class="col-md-12">
                <div class="card border border-primary border-3 shadow-sm rounded">
                    <div class="card-header">
                        <h4>UPDATE DATA MASTER JENIS DRY A</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('MasterJenisDryA.update', $MasterJenisDryA->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label><strong>Jenis</strong></label>
                                <input type="text" class="form-control" name="jenis"
                                    value="{{ old('jenis', $MasterJenisDryA->jenis) }}">
                                <!-- error message -->
                                @error('jenis')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kategori_susut"
                                    value="{{ old('kategori_susut', $MasterJenisDryA->kategori_susut) }}">
                                <!-- error message -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="upah_operator"
                                    value="{{ old('upah_operator', $MasterJenisDryA->upah_operator) }}">
                                <!-- error message -->
                                @error('upah_operator')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="pengurangan_harga"
                                    value="{{ old('pengurangan_harga', $MasterJenisDryA->pengurangan_harga) }}">
                                <!-- error message -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="harga_estimasi"
                                    value="{{ old('harga_estimasi', $MasterJenisDryA->harga_estimasi) }}">
                                <!-- error message -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="user_created" placeholder="Masukkan User Updated"
                                    class="form-control" value="{{ old('nama', $MasterJenisDryA->user_created) }}">
                                <!-- error message -->
                                @error('user_created')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" @error('status') is-invalid @enderror" name="status">
                                    <option value="1" {{ $MasterJenisDryA->status == 1 ? 'selected' : '' }}>Aktif
                                    </option>
                                    <option value="0" {{ $MasterJenisDryA->status == 0 ? 'selected' : '' }}>Tidak
                                        Aktif
                                    </option>
                                </select>
                            </div>
                            <div class="col-12 mt-2">
                                ...
                                <a href="{{ Route('MasterJenisDryA.index') }}" type="button" class="btn btn-danger"
