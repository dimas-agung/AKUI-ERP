                            ...
                            <table id="table1" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center">Berat Kotor Adding</th>
                                ...
                                <tbody>
                                    @forelse ($grading_warna_adding as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $item->berat_kotor_adding }}</td>
                                            <td class="text-center">{{ $item->prosentase_susut }}</td>
                                                ...
                                                <div class="form-button-action">
                                                    @if ($item->can_delete())
                                                        <form style="display: flex" id="deleteForm{{ $item->id }}"
                                                            action="{{ route('GradingWarnaAdding.destroy', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                    ...
                                    @empty
                                        <div class="alert alert-danger">
                                            Data Grading Warna Adding belum Tersedia.
                                        </div>
                                    @endforelse
                                </tbody>
                            </table>
...
@section('script')
    <script>
        ...
        function applyFilter() {
            ...
            var url = '{{ route('GradingWarnaAdding.index') }}';
