...
@endsection
@section('title')
    Master Tujuan Kirim Kedatangan
@endsection
@section('content')
    <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h5 class="card-title">
                            <div class="col-sm-12 d-flex justify-content-between">
                                Data Master Tujuan Kirim Kedatangan
                    ...
                    <div class="modal fade text-left modal-borderless" id="inlineForm" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('MasterTujuanKirimKedatangan.store') }}" method="POST">
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <div class="table-responsive">
                            <table id="table1" class="display" style="width:100%">
                                ...
                                <tbody>
                                    @forelse ($master_tujuan_kirim_kedatangan as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="form-button-action">
                                                    <form style="display: flex" id="deleteForm{{ $item->id }}"
                                                        action="{{ route('MasterTujuanKirimKedatangan.destroy', $item->id) }}"
                                                        method="POST">
                                                        <a href="{{ route('MasterTujuanKirimKedatangan.edit', $item->id) }}"
                                    ...
                                    @empty
                                        <div class="alert alert-danger">
                                            Data Master Tujuan Kirim Kedatangan belum Tersedia.
                                        </div>
                                    @endforelse
                                </tbody>
                            </table>
