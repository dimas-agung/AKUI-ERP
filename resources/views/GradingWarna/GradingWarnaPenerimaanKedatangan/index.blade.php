...
@endsection
@section('title')
    Grading Warna Penerimaan Kedatangan
@endsection
@section('content')
    <div class="col-md-12">
                    ...
                    <div class="card-body" style="overflow: auto;">
                        ...
                        <div class="table-responsive">
                            <table id="table1" class="display" style="width:100%">
                                ...
                                <tbody>
                                    @forelse ($grading_warna_penerimaan_kedatangan as $item)
                                        <tr>
                                                ...
                                                <div class="form-button-action">
                                                    @if ($item->can_delete())
                                                        <form style="display: flex" id="deleteForm{{ $item->nomor_job }}"
                                                            action="{{ route('GradingWarnaPenerimaanKedatangan.destroy', $item->nomor_job) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                    ...
                                    @empty
                                        <div class="alert alert-danger">
                                            Data Grading Warna Penerimaan Kedatangan belum Tersedia.
                                        </div>
                                    @endforelse
                                </tbody>
                            </table>
...
@section('script')
    <script>
        ...
        function applyFilter() {
            ...
            var url = '{{ route('GradingWarnaPenerimaanKedatangan.index') }}';
        ...
        function redirectToPage() {
            window.location.href = "{{ route('GradingWarnaPenerimaanKedatangan.create') }}";
        }
