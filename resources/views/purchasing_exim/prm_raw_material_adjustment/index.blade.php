                        ...
                        <h5 class="card-title">
                            <div class="col-sm-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span>Data Purchasing Raw Material Adjustment</span>
                                    <div>
                        ...
                        <div class="table-responsive">
                            <table id="table1" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($PrmRawMaterialAdjustment as $MasterPRIM)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-button-action">
                                                ...
                                                <form style="display: flex" id="deleteForm{{ $MasterPRIM->id }}"
                                                    action="{{ route('PrmRawMaterialAdjustment.destroy', $MasterPRIM->id) }}"
                                                    method="POST">
...
<script>
    function redirectToPage(pageType) {
        if (pageType === 'create') {
            window.location.href = "{{ route('PrmRawMaterialAdjustment.create') }}";
        }
    }
