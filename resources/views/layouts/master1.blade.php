                    ...
                    <ul class="menu">
                        ...
                        <li
                            ...
                            <ul class="submenu">
                                ...
                                <li
                                    class="submenu-item has-sub {{ Request::is('transit_pre_cleaning_stock*', 'pre_grading_halus_input*', 'pre_grading_halus_stock*', 'pre_grading_halus_adding*', 'pre_grading_halus_adding_stock*', 'adjustment_adding*', 'adjustment_stock*') ? 'active' : '' }}">
                                    <a href="#" class='submenu-link'>
