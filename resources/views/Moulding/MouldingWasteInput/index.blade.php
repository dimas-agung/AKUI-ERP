                    ...
                    <div class="card-body" style="overflow: auto;">
                        ...
                        <div class="table-responsive">
                            <table id="table1" class="display data-table" style="width:100%">
                                ...
                                <tbody>
                                    @forelse ($moulding_waste_input as $item)
                                        <tr>
                                                ...
                                                <div class="form-button-action">
                                                    @if ($item->can_delete())
                                                        <form style="display: flex" id="deleteForm{{ $item->id }}"
                                                            action="{{ route('MouldingWasteInput.destroy', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
...
@section('script')
    <script>
        ...
        //             ajax: "{{ route('MouldingWasteInput.index') }}",
        //             columns: [
        //                 // {
        //                 //     data: 'id',
        //                 //     name: 'id'
        ...
        function applyFilter() {
            ...
            var url = '{{ route('MouldingWasteInput.index') }}';
        ...
        function redirectToPage() {
            window.location.href = "{{ route('MouldingWasteInput.create') }}";
        }
