                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                                    ...
                                    <li
                                        ...
                                        <ul class="submenu submenu-level-2">
                                            ...
                                            <li class="submenu-item {{ Route::is('PreWashStock*') ? 'active' : '' }}">
                                                <a href="{{ route('PreWashStock.index') }}" class="submenu-link">Pre
                                                    Wash
                                                    <br>Stock</a>
                                            </li>
                        ...
                        @role('dry_a|admin')
                            ...
                            <li
                                class="sidebar-item has-sub {{ Route::is('DryAGradingCabut*', 'DryAGradingCabutStock*', 'DryAGradingHancuran*', 'DryAGradingHancuranStock*', 'DryAWasteInput*', 'DryAWasteStock*') ? 'active' : '' }}">
                                <a href="#" class='sidebar-link'>
                                    <i class="bi bi-three-dots"></i>
                                    <span>Dry A</span>
                                </a>
                        ...
                        @role('moulding|admin')
                            <li
                                class="sidebar-item has-sub {{ Route::is('GradingWarnaAdding*', 'GradingWarnaAddingStock*', 'GradingWarna*', 'GradingWarnaStock*', 'MouldingPenyebaran*', 'MouldingStock*', 'MouldingPengembalian*', 'TransitMoulding*', 'MouldingWasteInput*', 'MouldingWasteStock*') ? 'active' : '' }}">
                                <a href="#" class='sidebar-link'>
                                    <i class="bi bi-three-dots"></i>
                                    <span>Moulding</span>
                                </a>
