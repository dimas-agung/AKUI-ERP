            ...
            <div class="card-header">
                ...
                <form method="POST" class="row g-3" id="myForm">
                    ...
                    <div class="col-12">
                        ...
                        <a href="{{ Route('DryAGradingCabut.create') }}" type="button" class="btn btn-danger">Reset</a>
            ...
            $('#nomor_job').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.ajax({
                            url: '{{ route('MasterJenisDryA.getDataByJenis') }}',
                            method: 'GET',
                            data: {
                                jenis : arrayJenis
                            },
        ...
        function addRow() {
            if (validateForm()) {
                ...
                jenis_grading.forEach((v,i) => {
                    ...
                    let harga_estimasi = harga_estimasis[i];
                    let newRow = `<tr>` +
