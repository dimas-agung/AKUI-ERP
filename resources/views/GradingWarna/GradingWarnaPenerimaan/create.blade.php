...
@section('script')
    <script>
        ...
        //         targetSelect.empty();
        //         targetSelect.append('<option value="">Pilih Nomor BSTB</option>');

        //         let urlMap = {
        //             'hancuran': '{{ route('GradingWarnaPenerimaan.getDataHancuran') }}',
        //             'cabut': '{{ route('GradingWarnaPenerimaan.getDataCabut') }}'
        //         };

        //         if (urlMap[typeTransit]) {
        //             $.ajax({
        //                 url: urlMap[typeTransit],
        //                 method: 'GET',
        //                 async: false,
        //                 success: function(response) {
        //                     let dataTransit = response;
        //                     let uniqueNomorBstb = new Set(); // Using Set to prevent duplicates

        //                     dataTransit.forEach(v => {
        //                         if (!uniqueNomorBstb.has(v.nomor_bstb)) {
        //                             uniqueNomorBstb.add(v.nomor_bstb);
        //                             targetSelect.append(
        //                                 `<option value="${v.nomor_bstb}" class="${typeTransit}">${v.nomor_bstb}</option>`
        //                             );
        //                         }
        //                     });
        //                 },
        ...
        //         if (!selectedNomorBSTB) return;

        //         let urlMap = {
        //             'hancuran': '{{ route('GradingWarnaPenerimaan.setHancuran') }}',
        //             'cabut': '{{ route('GradingWarnaPenerimaan.setCabut') }}'
        //         };

        //         if (urlMap[selectedClass]) {
        //             $.ajax({
        //                 url: urlMap[selectedClass],
        //                 method: 'GET',
        //                 data: {
        ...
        //                             '</td>');
        //                         newRow.append('<td>' + (rowData.berat_kotor || '') +
        //                             '</td>');
        //                         newRow.append('<td>' + rowData.jenis_grading + '</td>');
        //                         newRow.append('<td>' + (rowData.berat_1_grading || '') +
        //                             '</td>');
        //                         newRow.append('<td>' + (rowData.pcs_1_grading || '') +
        //                             '</td>');
        //                         // Logika untuk berat 2 grading

        //                         let berat2Grading = typeTransit === 'hancuran' ? rowData
        //                             .berat_job : (rowData.berat_2_grading || '');
