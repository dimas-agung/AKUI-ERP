                ...
                <form action="{{ route('PrmRawMaterialOutputItem.update', $PrmRawMOIC->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('doc_no') is-invalid @enderror" name="doc_no"
                            value="{{ old('doc_no', $PrmRawMOIC->doc_no) }}" placeholder="Masukkan nomor Dokument">
                    ...
                    <div class="form-group">
                        <label>Id Box</label>
                        <input type="text" class="form-control @error('id_box') is-invalid @enderror" name="id_box"
                            value="{{ old('id_box', $PrmRawMOIC->id_box) }}" placeholder="Masukkan id box">
                        <!-- error message untuk title -->
                        @error('id_box')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('berat') is-invalid @enderror" name="berat"
                            value="{{ old('berat', $PrmRawMOIC->berat) }}" placeholder="Masukkan berat">
                        <!-- error message untuk title -->
                        @error('berat')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('kadar_air') is-invalid @enderror" name="kadar_air"
                            value="{{ old('kadar_air', $PrmRawMOIC->kadar_air) }}" placeholder="Masukkan kadar air">
                        <!-- error message untuk title -->
                        @error('kadar_air')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('inisial_tujuan') is-invalid @enderror"
                            name="inisial_tujuan" value="{{ old('inisial_tujuan', $PrmRawMOIC->inisial_tujuan) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('modal') is-invalid @enderror" name="modal"
                            value="{{ old('modal', $PrmRawMOIC->modal) }}" placeholder="Masukkan modal">
                        <!-- error message untuk title -->
                        @error('modal')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
