                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayoutsPro" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="{{ url('/master_supplier_raw_material') }}">Supplier Raw Material</a>
                                    <a class="nav-link" href="{{ url('/master_jenis_raw_material') }}">Jenis Raw Material</a>
                                    <a class="nav-link" href="{{ url('/master_tujuan_kirim_raw_material') }}">Tujuan Kirim Raw Material</a>
                                </nav>
                            </div>
