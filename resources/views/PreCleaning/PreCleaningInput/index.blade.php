        ...
        <div class="card border border-primary border-3">
            <div class="card-header">
                <div class="col-sm-12 d-flex justify-content-between">
                    ...
                    <a href="{{ Route('PreCleaningInput.create') }}" class="btn btn-outline-success rounded-pill">
                        ...
                        <tbody>
                            @forelse ($PreCleaningI as $item)
                                <tr>
                                    ...
                                    <td class="text-center">{!! number_format($item->berat_kirim, 2, ',', '.') !!}</td>
                                    <td class="text-center">{!! number_format($item->pcs_kirim, 0, ',', '.') !!}</td>
